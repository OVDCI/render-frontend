...
function Edituser(){
    ...
    function getsingledata(){
        axios.get(`https://users-api-app-h5uk.onrender.com/getsingleuser/${id}`).then(res=>{
            setnewdata({
                Name:res.data.name,
    ...
    function submitHandler(e){
        ...
        try{
            axios.put(`https://users-api-app-h5uk.onrender.com/Edit/${id}`,updatedData);
            setnewdata({
                Name:"",
                Email:"",
                number:""
    ...
    function deleteuser(){
        try {
            axios.delete(`https://users-api-app-h5uk.onrender.com/deleteuser/${id}`);
